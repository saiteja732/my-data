...
public class HrSelection extends HttpServlet {
	static Logger logger = Logger.getLogger(HrSelection.class);
			...
			try {
				...
				for (String s : str) {
					...
					if (ch == 's') {
						...
						ps.setString(1, str1);
						ps.executeQuery();
						String sql1 = "update jobapplication set appstatus='hr' where jsid='" + str1 + "'";
						PreparedStatement ps1 = con.prepareStatement(sql1);
						ps1.executeUpdate();
						String sql2 = "update jobapplication set trstatus='done' where jsid='" + str1 + "'";
