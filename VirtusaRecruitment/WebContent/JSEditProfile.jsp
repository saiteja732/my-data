			...
			<div class="col-md-6">
				<div class="row author">
					...
					<div class="col-sm-8 author-name">
						...
						<p class="small muted-light wow animated fadeInUp"><%=js.getEmail() %></p>
					</div>
				</div>
			</div>
		</div>
...
<div class="col-sm-8" style="margin-left:10%; margin-top:1%;">
	...
	<div class="col-xs-3">
		 <div class="form-group">
				...
				<input type="number" name="hpercentage" step="0.01" maxlength="5" pattern="[0-9]{2}[.][0-9]{2}|[0-1]{3}$" title="Please Enter the valid percentage" placeholder="12th Percentage " class="form-control">
			</div>
	...
	<div class="col-xs-3">
		 <div class="form-group">
				...
				<input type="number" name="spercentage" step="0.01" placeholder="10th Percentage " maxlength="5" pattern="[0-9]{2}[.][0-9]{2}|[0-1]{3}$" title="Please Enter the valid percentage" class="form-control">
			</div>
	...
	<div class="col-xs-3">
		 <div class="form-group">
				...
				<input type="text" name="work" maxlength="20"  placeholder="Work Location" class="form-control">
			</div>
