	...
	<div class="container" style="margin-top: -46%; display: none;">
			...
			<div class="col-md-6">
				<div class="intro-book">
					<img src="img/virtusa.png" style="width: 95%;" alt="">
				</div>
			</div>
			...
			<div class="col-md-6 login-form" >
				...
				<a href="JobListDisplay.jsp" class="scrollto btn btn-white">Jobseeker</a>
				<a href="loginPage1.jsp" class="btn btn-blue">Employee</a>
				<a href="addEmployee.jsp" class="btn btn-blue">Admin</a>
			</div>
			</div>
	</div>
	</header>
