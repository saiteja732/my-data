...
<div class="container-fluid rowback"> 
	<% String appstatus=request.getParameter("st");
		HttpSession hs=request.getSession();
		String appid=(String)hs.getAttribute("appids");
	%>

	
	<div class="item">
					<div class="review text-center wow animated fadeInUp">
					<h4 class="subheading gray wow animated fadeInUp">Your application status for id(<%=appid %>) is <%=appstatus %></h4>
