	...
	<div class="main"  style="margin-top: -52%; display: none;"> 
		...
		<div class="login-form"> 
			...
			<div class="agileits-top">
				<form action="JSChangePassword" method="post" name="myform" onsubmit="return validate()">
				<div class="styled-input">
						<label>Old Password</label><br><input type="password" name="oldpass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one uppercase and lowercase letter, and at least 8 or more characters" required> 
