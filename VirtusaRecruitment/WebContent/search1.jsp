...
<%@page import="com.virtusa.vrps.model.ApplicantDet"%>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right main-nav">
				...
				<li><a href="ApplicantData" class="scrollto active" >Application</a></li>
...
<div class="container-fluid rowback">  <!--/ mujhe iske nichai se looping krni hai-->
	...
	<%
				...
				try {
					...
					List<ApplicantDet> js = (List<ApplicantDet>) request.getAttribute("jListInfo");
					if(js.isEmpty()){
						%>
						<div class="item">
					...
					<table>
						...
						<%
						Iterator<ApplicantDet> it = js.iterator();
						while (it.hasNext()) {
							ApplicantDet ji = (ApplicantDet) it.next();
						%>
