...
<section>
	...
	<div class="main"  style="margin-top: -52%; display: none;"> 
		<form action="JSForgotPass" method="post" name="myform" onsubmit="return validate()" autocomplete="off">
		<div class="login-form"> 
			<h2 style="color:white;">Change Password</h2> 
			<div class="agileits-top">
				
				<div class="styled-input">
						<label>Email</label><br><input type="text" name="em" pattern="[a-z][a-z0-9._%+-]+@gmail.[a-z]{2,}$" title="Must be gmail id starting with letter" required> 
