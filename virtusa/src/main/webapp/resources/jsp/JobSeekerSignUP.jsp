...
<form name="myForm" action="register.as"  method="post" onsubmit="return validate()" autocomplete="off">
<div class="login-form"> 
<h2 style="color:white;">Jobseeker SignUp</h2> 
<div class="agileits-top">
<div class="row">
<div class="col-sm-6 styled-input">
<label>First Name</label><br><input type="text" name="fname" pattern="([A-Z][a-z]*)" title="Only First letter should be captial" required/>
<input type="hidden" value="${just.jsid}" name="jsid">
<span></span>
</div>
<div class=" col-sm-6 styled-input">
<label>Last Name</label><br><input type="text" name="lname"  pattern="([A-Z][a-z]*)" title="Only First letter should be captial" required> 
...
Enter the unique email..
<span></span>
</div>
<div class="col-md-6 styled-input">
<label>Phone</label><br><input type="text" name="phoneno"  pattern="[6-9]{1}[0-9]{9}" title="Enter the valid phone number" required> 
...
<div class="row">
<div class="col-md-6 styled-input">
<label>Password</label><br><input type="password" name="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one uppercase and lowercase letter, and at least 8 or more characters" required/>
